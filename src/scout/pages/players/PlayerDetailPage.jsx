...
import ActionsDropdown from '../../components/players/ActionsDropdown';
            ...
            <div className={styles.statsRow}>
                ...
                <div className={styles.statItem}>
                    <span className={styles.statVal}>
                        {player.preferred_foot === 'right' ? 'Rechts'
                            : player.preferred_foot === 'left' ? 'Links'
                            : player.preferred_foot === 'both' ? 'Beide'
                            : '\u2014'}
                    </span>
