...
const AddReportPage = () => {
    ...
    return (
          <div className={styles.page}>
                  <button className={styles.back} onClick={() => navigate(-1)}>&larr; Terug</button>
                  <h1 className={styles.title}>Nieuw scoutingrapport</h1>

                  <div className={styles.form}>
                    {/* Speler */}
                            <section className={styles.section}>
                                        <h2 className={styles.sectionTitle}>Speler</h2>
                                        <div className={styles.fieldGroup}>
                                                      <label className={styles.label}>Speler *</label>
                    ...
                    {/* Wedstrijdinfo */}
                          <section className={styles.section}>
                                    <h2 className={styles.sectionTitle}>Wedstrijdinformatie</h2>
                                    <div className={styles.row}>
                                                <Input label="Datum" type="date" value={form.match_date} onChange={set('match_date')} />
                                                <div className={styles.fieldGroup}>
                                                              <label className={styles.label}>Type observatie</label>
                    ...
                    {Object.entries(grouped).length > 0 && (
                      <section className={styles.section}>
                                  <h2 className={styles.sectionTitle}>Evaluatie per criterium</h2>
                                  <p className={styles.hint}>Score 1&ndash;10 per criterium. Vul enkel in wat je hebt kunnen observeren.</p>
                    ...
                    {/* Potentieel */}
                          <section className={styles.section}>
                                    <h2 className={styles.sectionTitle}>Potentieel &amp; aanbeveling</h2>
                                    <div className={styles.row}>
                                                <div className={styles.fieldGroup}>
                                                              <label className={styles.label}>Potentieel (1&ndash;5 sterren)</label>
                    ...
                    {/* Tekstuele beoordeling */}
                          <section className={styles.section}>
                                    ...
                                    <div className={styles.fieldGroup}>
                                                <label className={styles.label}>Samenvatting</label>
                                    ...
                                    <div className={styles.row}>
                                                <div className={styles.fieldGroup}>
                                                              <label className={styles.label}>Sterke punten</label>
                    ...
                    {error && <div className={styles.error}>{error}</div>}
                          ...
                          <div className={styles.formActions}>
                                    <Button variant="secondary" type="button" onClick={() => navigate(-1)}>Annuleren</Button>
                                    <Button variant="secondary" type="button" loading={loading} onClick={() => handleSubmit('draft')}>Opslaan als draft</Button>
                                    <Button variant="primary" type="button" loading={loading} onClick={() => handleSubmit('completed')}>Rapport voltooien</Button>
                          </div>
                  </div>
          </div>
        );
