    ...
    return (
          <form onSubmit={handleSubmit} className={styles.form}>
                  ...
                  <div className={styles.selectWrap}>
                            <label className={styles.selectLabel}>{t('auth.platform')}</label>label>
            ...
            {displayError && <p className={styles.errorMsg}>{displayError}</p>p>}
...
export default RegisterForm;</span>
